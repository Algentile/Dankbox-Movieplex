...
var team = [
	...
	member('mradford', 'Michael', 'Radford', 'senior'),
	member('jjsherma', 'Joshua' , 'Sherman', 'senior'),
	member('henryshepher', 'Henry', 'Shepherd', 'senior'),
	member('dgandle' , 'Douglas' , 'Gandle','junior'),
	member("algentile", 'Anthony', 'Gentile','junior')
